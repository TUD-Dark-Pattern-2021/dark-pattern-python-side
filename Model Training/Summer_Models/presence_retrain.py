...
presence["classification"] = "Not Dark"
 ...
 # For later Model Training the model, we should remove the duplicate input to reduce overfitting.
...
# Check the frequency distribution of the Model Training pattern classification with pattern classification names.
...
# Check the frequency distribution of the encoded Model Training pattern classification with encoded integers.
